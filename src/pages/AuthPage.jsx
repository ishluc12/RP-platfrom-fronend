...
import kigaliCollegeLogo from "../assets/images/kigali_college_logo.png"
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if (isRegistering) {
                ...
                res = await authService.register(registerData)
            } else {
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <img src={kigaliCollegeLogo} alt="Kigali College Logo" className="mx-auto h-24 mb-4 object-contain" />
                </div>
